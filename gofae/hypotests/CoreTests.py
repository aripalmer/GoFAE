...
class AndersonDarling(HTest):
    ...
    def __init__(self, emp_dist, n, device, new_stat, T_alpha, use_emp=False):
        self.test = 'ad'
        self.optdir = -1.
...
class EppsPulley1(HTest):
    ...
    def teststat(self, x):
        ...
        self.TEP = -torch.log(n * TEP_og + 1e-8)
        return self.TEP
...
class ShapiroFrancia(HTest):
    ...
    def __init__(self, emp_dist, sf_wts, new_mu, new_sigma, device, new_stat, T_alpha, use_emp=False):
        self.test = 'sf'
        self.optdir = 1.
        self.emp_dist = emp_dist
        self.sf_wts = sf_wts
...
class ShapiroWilk(HTest):
    ...
    def __init__(self, emp_dist, sw_wts, new_mu, new_sigma, device, new_stat, T_alpha, use_emp=False):
        self.test = 'sw'
        self.optdir = 1.
        self.emp_dist = emp_dist
        self.sw_wts = sw_wts
...
class HenzeZirkler(HTest):
    ...
    def __init__(self, emp_dist, device, new_stat, n, m, T_alpha, use_emp):
        self.test = 'hz'
        self.optdir = -1.
        self.emp_dist = emp_dist
        self.device = device
...
class MardiaSkew(HTest):
    ...
    def __init__(self, emp_dist, n_z, device, new_stat, T_alpha, use_emp):
        self.test = 'mardiask'
        self.optdir = -1.
        self.emp_dist = emp_dist
        self.n_z = n_z
...
class Royston(HTest):
    ...
    def __init__(self, emp_dist, e, device, sf, sw, new_stat, n, T_alpha, use_emp):
        self.test = 'royston'
        self.emp_dist = emp_dist
        self.optdir = -1.
        self.e = e
